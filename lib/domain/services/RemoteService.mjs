...
import {createCookieSupportedAxiosInstance} from 'iab/lib/utils/axios';

class RemoteService {
    async tryRemoteLogin(userId, password) {
        const axiosInstance = createCookieSupportedAxiosInstance();
