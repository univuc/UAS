...
class DecodeInvitation extends UseCase {
    constructor({invitationAuthenticator}) {
        super();

        this.invitationAuthenticator = invitationAuthenticator;
    }

    async onExecute({encodedInvitation}) {
        return this.invitationAuthenticator.decodeInvitation(encodedInvitation);
    }
}

export default DecodeInvitation;
