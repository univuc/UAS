...
class ValidateInvitation extends UseCase {
    constructor({invitationValidator}) {
        super();

        this.invitationValidator = invitationValidator;
    }

    async onExecute({invitation}) {
        return await this.invitationValidator.validateInvitation(invitation);
    }
}
