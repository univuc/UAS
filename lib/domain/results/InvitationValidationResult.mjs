...
export default {
    SUCCESS: 'INVITATION_VALIDATION_SUCCESS',
    USER_EXISTS: 'INVITATION_VALIDATION_USER_EXISTS',
    SLACK_USER_ID_DUPLICATED: 'INVITATION_VALIDATION_SLACK_USER_ID_DUPLICATED',
};
